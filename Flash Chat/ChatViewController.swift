...
//        cell.messageBody.text = messageArray[indexPath.row]
        ...
        //For setting avatar image for sender
    ...
    @IBAction func sendPressed(_ sender: AnyObject) {
        ...
        let messageDB = Database.database().reference().child("MessagesDB")
        ...
        messageDB.childByAutoId().setValue(messageDictionary){
            ...
            if error != nil{
                print("Error in sending messages: ", error!)
            }
            else{
    ...
    func retrieveMessages(){
        let messagesDB = Database.database().reference().child("MessagesDB")
    ...
    @IBAction func logOutPressed(_ sender: AnyObject) {
        ...
        do{
            ...
            print("Error has occured during logging out")
        }
